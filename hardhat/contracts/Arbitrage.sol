...
contract Arbitrage is Ownable {
    ...
    function pancakeCall(
        ...
        _doCallback(_sender, _amount0, _amount1, _data, msg.sender);
    }
    ...
    function _doCallback(
        ...
        require(_msgSender == IUniswapV2Factory(mainFactory).getPair(token0, token1), 'UNAUTHORIZED');
        ...
        outToken.transfer(_msgSender, refund);
    }
}